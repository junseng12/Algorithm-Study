...
| Day    | 주제                                 | 문제 예시                       | 상태    |
| ------ | ------------------------------------ | ------------------------------- | ------- |
| Day 26 | 트리 DP 고급                         | 2533\_사회망 서비스             | ❌ 예정 |
| Day 27 | 트리에서 거리/정보 축적              | 1240\_노드 사이 거리            | ❌ 예정 |
| Day 28 | Merkle Tree 개념 학습 + 기초 구현    | 직접 구현 (머클 트리 해시 구현) | ❌ 예정 |
| Day 29 | 머클트리 기반 응용 문제 설계 및 풀이 | 프로젝트형 실습                 | ❌ 예정 |
...
| Day    | 주제                           | 문제 예시             | 상태    |
| ------ | ------------------------------ | --------------------- | ------- |
| Day 30 | Trie 기본 구현 및 응용         | 5052\_전화번호 목록   | ❌ 예정 |
| Day 31 | Trie 최적화 적용               | 5670\_휴대폰 자판     | ❌ 예정 |
| Day 32 | 문자열 해시 응용               | 1351\_무한 수열       | ❌ 예정 |
| Day 33 | Merkle Patricia Trie 개념 학습 | 개념 학습 + 간단 실습 | ❌ 예정 |
